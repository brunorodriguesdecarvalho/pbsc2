function editar(id) { 
    console.log("Iniciando processo para editar: " , id)
    $.get( '/ativEdit' , (id) => { console.log(id) } )
}
/*
function getAtividades() {
    $.get( '/atividades' , (atividades) => { atividades.forEach(editarAtividades) }
}

function editarAtividades(atividades){  
